...
"Carpeta Proyecto_Filogenia creada y abierta."

# 2. Descargar genes con edirect ===
#Descargando secuencias en hoffman
...
echo "Archivos .fasta y MUSCLE copiados a carpeta Secuencias_muscle."

# 4. Instrucción para edición manual
echo "DESCARGA la carpeta Secuencias_muscle a tu computador personal."
